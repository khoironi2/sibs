    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= base_url('admin/create_penjualan_sampah'); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="berat_penjualan" name="berat_penjualan" required>
                        <?= form_error('berat_penjualan', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>

                    <div class="form-group">
                        <label for="harga_penjualan">Harga</label>
                        <input type="text" class="form-control" id="harga_penjualan" name="harga_penjualan" required>
